...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	<head>
		...
		<title>An update was added to %%POST_TITLE%%</title>
    	<style type="text/css">
			p{
				margin:10px 0;
				padding:0;
																			...
																			<tbody>
																				<tr>
																					<td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">												
																						<h2 style="text-align: center;"><span style="font-family:open sans,helvetica neue,helvetica,arial,sans-serif">New update for the campaign <br>%%POST_TITLE%%</span></h2>																						
																					</td>
																				</tr>
																			</tbody>
																		</table>

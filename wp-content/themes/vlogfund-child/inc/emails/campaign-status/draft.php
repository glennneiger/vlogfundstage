																...
																<table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
																	<tr style="padding:0;text-align:left;vertical-align:top">
																		<th style="Margin:0;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left">
																			<center data-parsed="" style="min-width:532px;width:100%"><small align="center" class="float-center" style="color:#cacaca;font-size:80%">Thank you for creating a campaign on Vlogfund.<br>Your campaign is currently saved as a draft. If you wish to edit it log into Vlogfund<br>1.Click on Account, located on the right site of the navigation bar<br>2.Click ”My Campaigns” in the drop-down menu<br>3.Click on the little pencil to edit it</small></center>
																		</th>

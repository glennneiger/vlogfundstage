...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	<head>
		...
		<title>Your campaign is waiting</title>
    	<style type="text/css">
			p{
				margin:10px 0;
				padding:0;
																			...
																			<tbody>
																				<tr>
																					<td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">												
																						<h2 style="text-align: center;"><span style="font-family:open sans,helvetica neue,helvetica,arial,sans-serif">Your campaign is still saved as a draft</span></h2>																						
																					</td>
																				</tr>
																			</tbody>
																		</table>
																...
																<table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
																	<tr style="padding:0;text-align:left;vertical-align:top">
																		<th style="Margin:0;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left">
																			<center data-parsed="" style="min-width:532px;width:100%"><small align="center" class="float-center" style="color:#cacaca;font-size:80%">Thank you for creating a campaign on Vlogfund.<br>Your campaign is currently still saved as a draft. If you wish to edit it log into Vlogfund<br>1.Click on Account, located on the right site of the navigation bar<br>2.Click ”My Campaigns” in the drop-down menu<br>3.Click on the little pencil to edit it<br><br>Vlogfund <a href="https://www.vlogfund.com/terms?utm_source=autoresponder&utm_medium=email&utm_campaign=campaign-creation&utm_content=textlink" target="_blank" style="Margin:0;color:#dc2c5d;font-family:Helvetica,Arial,sans-serif;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left;text-decoration:none">Terms & Conditions</a></small></center>
																		</th>

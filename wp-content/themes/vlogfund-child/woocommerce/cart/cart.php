...
<div class="sfc-campaign-archive-post">
            ...
            <label for="donation_amount_<?php echo $product_id;?>_30" class="sfc-campaign-amount-button"><span><?php echo wc_price(30);?></span></label>
            ...
            <label for="donation_amount_<?php echo $product_id;?>_20" class="sfc-campaign-amount-button"><span><?php echo wc_price(20);?></span></label>
            ...
            <label for="donation_amount_<?php echo $product_id;?>_10" class="sfc-campaign-amount-button"><span><?php echo wc_price(10);?></span></label>
            ...
            <label for="donation_amount_<?php echo $product_id;?>_5" class="sfc-campaign-amount-button"><span><?php echo wc_price(5);?></span></label>

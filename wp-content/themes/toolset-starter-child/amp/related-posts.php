<?php
/*https://isabelcastillo.com/related-posts-wp-amp*/
if ( ! is_single() ) {
    return;
}
    ...
    if ( $related ) {   ?>
        <div class="amp-wp-meta amp-wp-tax-tag">
            ...
            <?php foreach( $related as $post) {
                setup_postdata( $post );
                ?>
                <li><a id="amp-related-article" href="<?php echo esc_url( amp_get_permalink( get_the_id() ) ); ?>" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></li>
            <?php } ?>
            </ul>
        </div>
    <?php

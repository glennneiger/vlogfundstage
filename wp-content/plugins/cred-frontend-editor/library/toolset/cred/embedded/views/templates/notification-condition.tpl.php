...
<p id="cred_notification_field_condition-<?php echo $ii; ?>-<?php echo $jj; ?>">
    <i title="<?php echo esc_attr(__('Please select a field', 'wp-cred')); ?>" id="notification_field_required-<?php echo $ii; ?>-<?php echo $jj; ?>" class="fa fa-warning" style="display:none;"></i>
    ...
    }" class='fa fa-refresh cred-refresh-button' title="<?php echo esc_attr(__('Click to refresh (if settings changed)','wp-cred')); ?>">&nbsp;</a>&nbsp;

...
<span id="cred-scaffold-button" class="cred-media-button">
    <a href='javascript:;' id="cred-scaffold-button-button" class='button cred-button' title='<?php echo esc_attr(__('Auto-Generate Form', 'wp-cred')); ?>'>
        <i class="icon-cred-logo ont-icon-18"></i><?php _e('Auto-Generate Form', 'wp-cred'); ?></a>
    <div id="cred-scaffold-box" class="cred-popup-box">
        <div class='cred-popup-heading'>
            <h3><?php _e('Auto-generate Form Content', 'wp-cred'); ?></h3>
            <i title='<?php echo esc_attr(__('Close', 'wp-cred')); ?>' class='fa fa-times cred-close-button cred-cred-cancel-close'></i>
        </div>
        <div id="cred-scaffold-box-inner" class="cred-popup-inner">
            <textarea id="cred-scaffold-area" rows=8>
            </textarea>
            <p>
                <?php _e("This auto-generator includes inputs for all the fields that belong to the form's content type.", 'wp-cred'); ?>

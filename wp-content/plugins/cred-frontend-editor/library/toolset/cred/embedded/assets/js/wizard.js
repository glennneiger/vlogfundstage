                    ...
                    } else
                    {
                        ...
                        if (cred.doCheck(self.step))
                        {
                            ...
                            if (tinyMCE && tinyMCE.get('credformactionmessage') && tinyMCE.get('credformactionmessage').getContent() != '') {
                                action_message = '&_cred[form][action_message]=' + encodeURIComponent( tinyMCE.get('credformactionmessage').getContent() );
                            }

                            for (var i = 0; i <= 20; i++) {
                                if ($('#credmailbody' + i) && $('#credmailbody' + i).length) {
                                    if (tinyMCE && tinyMCE.get('credmailbody' + i) && tinyMCE.get('credmailbody' + i).getContent() != '') {
                                        action_message += '&_cred[notification][notifications][' + i + '][mail][body]=' + encodeURIComponent( tinyMCE.get('credmailbody' + i).getContent() );
                                    }
                                }
                            }

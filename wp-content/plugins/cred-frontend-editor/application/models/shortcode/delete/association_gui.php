...
/**
 * Class CRED_Shortcode_Delete_Association_GUI
 *
 * @since m2m
 */
class CRED_Shortcode_Delete_Association_GUI extends CRED_Shortcode_Base_GUI {
	...
	*/
	...
	public function register_shortcode_data( $cred_shortcodes ) {
		$cred_shortcodes[ CRED_Shortcode_Delete_Association::SHORTCODE_NAME ] = array(
	...
	public function filter_shortcode_group_before_register( $group_data, $group_id ) {
		...
		if ( 'cred-extra' === $group_id ) {
			$group_data['fields'][ CRED_Shortcode_Delete_Association::SHORTCODE_NAME ] = array(
				'name'		=> __( 'Delete relationship', 'wp-cred' ),
				'shortcode'	=> CRED_Shortcode_Delete_Association::SHORTCODE_NAME,
				'callback'	=> $this->get_shortcode_callback( CRED_Shortcode_Delete_Association::SHORTCODE_NAME, __( 'Delete relationship', 'wp-cred' ) )
			);
		}

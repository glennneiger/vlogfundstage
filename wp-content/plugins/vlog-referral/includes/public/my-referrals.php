				...
				<?php if( $referred = vlogref_get_user_referrals( array( 'page' => $page ) ) ) : //Check Referred Has Data
					foreach( $referred as $camp ) :
						...
						<tr class="woocommerce-orders-table__row woocommerce-orders-table__row--status-on-hold order">
							...
							<td class="woocommerce-orders-table__cell woocommerce-orders-table__cell-order-status" data-title="<?php _e('Campaign Status','vlog-referral');?>"><span class="woocommerce-button button view <?php echo strtolower($campaign_status).' sfc-my-campaigns-status-'.strtolower($campaign_status);?>"><?php echo $campaign_status;?></span></td>

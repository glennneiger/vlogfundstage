    	...
    	<div class="vf-referral-col">
			<h1 class="vf-referral-headline"><?php _e('Refer your friends - Win awesome prizes','vlog-referral');?></h1>
      		<div class="vf-referral-current">
				...
				<div class="vf-ambassador-stats">
					<div class="vf-abassador-stat"><?php echo vlogref_upvotes_user_referral_count($campaign);?><br><span><?php _e('Your Referrals','vlog-referral');?></span></div>
					<div class="vf-abassador-stat">#<?php echo vlogref_upvotes_user_rank($campaign, $userdata->ID);?><br><span><?php _e('Current Position','vlog-referral');?></span></div>
					<div class="vf-abassador-stat"><?php echo vlogref_upvotes_campaign_goal($campaign);?> <br><span><?php _e('Goal','vlog-referral');?></span></div>
			...
			<div class="vf-referral-ranking">
				<table class="woocommerce-orders-table woocommerce-MyAccount-orders shop_table shop_table_responsive my_account_orders account-orders-table">
					...
					<tbody>
						<?php if( $rankings = vlogref_upvotes_get_campaign_referrals( array( 'campaign' => $campaign, 'page' => $page, 'limit' => 20 ) ) ) : //Chek Ranking Not Empty							
							foreach( $rankings as $rank ) : //Loop to List Referrals
								...
								<tr class="woocommerce-orders-table__row woocommerce-orders-table__row--status-on-hold order">
									<td class="woocommerce-orders-table__cell woocommerce-orders-table__cell-order-number" data-title="<?php _e('Position', 'vlog-referral');?>">
										<?php echo '#'.vlogref_upvotes_user_rank($campaign, $referred_by->ID) . $winner_str;?>
									</td>
			...
			<?php endif; //Endif ?>
				...
				<div id="referral-prizes">
					<?php if( !empty( $winners ) && array_key_exists($userdata->ID, $winners) ) : //Current User Winner ?>
						...
						<?php $price_data = vlogref_upvotes_prize_details($winners[$userdata->ID]); ?>

					...
					<div class="grid-col">
						<div class="related-blog-col featured">
							<a href="<?php echo get_permalink( $rba_big->ID );?>">
								<figure>
									<?php if( $rba_big_thumb = get_the_post_thumbnail_url( $rba_big->ID, 'medium_large') ) : //Check Thumbnail ?>
								...
								<div class="grid-col">
									<div class="related-blog-col">
										<a href="<?php echo get_permalink( $rbapost->ID );?>">
											<figure>
												<?php if( $rbapost_thumb = get_the_post_thumbnail_url( $rbapost->ID, 'product-thumbnail') ) : //Check Thumbnail ?>

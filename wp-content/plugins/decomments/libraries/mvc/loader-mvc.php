...
class DECOM_Loader_MVC extends DECOM_Loader {
	...
	public static function getPathTheme() {
		...
		if ( is_dir( DECOM_CUSTOM_TEMPLATE_PATH ) ) {
			$decom_template_path = DECOM_CUSTOM_TEMPLATE_PATH;
		}

		return $decom_template_path;
	}

	public static function getUrlTheme() {
		$decom_template_url = DECOM_TEMPLATE_URL_DEFAULT;

		if ( is_dir( DECOM_CUSTOM_TEMPLATE_PATH ) ) {
			$decom_template_url = DECOM_CUSTOM_TEMPLATE_URL;
		}

		return $decom_template_url;
	}

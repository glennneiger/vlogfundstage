...
class WC_Social_Login_Integrations {
	...
	public function __construct() {
		...
		if ( $this->is_memberships_active() ) {
			$this->memberships = wc_social_login()->load_class( '/includes/integrations/class-wc-social-login-integrations-memberships.php', 'WC_Social_Login_Integrations_Memberships' );
		}
	}

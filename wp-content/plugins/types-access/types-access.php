...
define( 'TACCESS_LOCALE_PATH', TACCESS_PLUGIN_PATH . '/locale' );
...
onthego_initialize(TACCESS_PLUGIN_PATH . '/vendor/toolset/onthego-resources', TACCESS_PLUGIN_URL . '/vendor/toolset/onthego-resources/');

require TACCESS_PLUGIN_PATH . '/vendor/toolset/toolset-common/loader.php';
toolset_common_initialize(TACCESS_PLUGIN_PATH . '/vendor/toolset/toolset-common', TACCESS_PLUGIN_URL . '/vendor/toolset/toolset-common/');
...
function taccess_on_activate()
{
	...
	Access_Helper::toolset_access_update_settings();
}

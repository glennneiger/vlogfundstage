<div id="tab-verify-sender"  data-prefix="wposes" class="wposes-tab wposes-content">
	...
	<form id="wposes-setup-verify-senders-form">
		...
		<input id="wposes-setup-verify-email" class="wposes-show-email wposes-setup-verify-input" type="email" style="display:none;" value="<?php echo get_site_option( 'admin_email' ); ?>" required="required" />
	</form>

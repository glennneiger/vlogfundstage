<div id="tab-start" data-prefix="wposes" class="wposes-tab wposes-content">
	<div>
		...
		<p><?php printf( __( 'If you\'d rather configure everything manually, you can <a href="%s">skip setup</a> and enter the settings for the plugin.', 'wp-offload-ses' ), $this->get_plugin_page_url( array( 'skip-setup' => true, 'hash' => 'settings' ) ) ); ?></p>

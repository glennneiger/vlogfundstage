				...
				<td>
					...
					<p>
						...
						<span class="helper-message bottom">
							<?php _e( 'When enabled, WP Offload SES will insert a transparent 1x1 pixel into emails so email opens can be tracked.', 'wp-offload-ses' ); ?>
						</span>
					</p>
				</td>
			</tr>
			...
			<tr class="<?php echo $args['tr_class'];?>">
				...
				<td>
					...
					<p>
						...
						<a class="general-helper" href="#"></a>
						<span class="helper-message bottom">
							<?php _e( 'When enabled, WP Offload SES will alter the links in emails sent so that clicks can be tracked before redirecting the recipient to the original link destination.', 'wp-offload-ses' ); ?>
						</span>
					</p>
				</td>
			</tr>
			...
			<tr>
				<td colspan="2">
					<p>
						...
						<a class="wposes-launch-setup-wizard" href="<?php echo $this->get_plugin_page_url( array( 'setup-wizard' => true ) ); ?>"><?php _e( 'Launch Setup Wizard', 'wp-offload-ses' ); ?></a>
					</p>
				</td>
			</tr>
		</table>
